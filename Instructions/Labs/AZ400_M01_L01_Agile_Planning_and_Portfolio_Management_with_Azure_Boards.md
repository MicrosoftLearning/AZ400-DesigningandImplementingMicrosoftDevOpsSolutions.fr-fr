...
1. Vérifiez que le navigateur web affiche votre organisation Azure DevOps avec le projet **EShopOnWeb** que vous avez généré dans l’exercice précédent.
    ...
    > **Remarque** : vous pouvez également accéder directement à la page du projet en saisissant l’URL [<https://dev.azure.com/>`<your-Azure-DevOps-account-name>`/EShopOnWeb), où l’espace réservé `<your-Azure-DevOps-account-name>` représente le nom de votre compte.

2. Cliquez sur l’icône d’engrenage étiquetée **Paramètres du projet** située dans le coin inférieur gauche de la page pour ouvrir la page **Paramètres du projet**.

    ![Fenêtre de projet Azure DevOps. Cliquez sur l’option « Paramètres du projet »](images/m1/project_settings_v1.png)

3. Dans la section **Général**, sélectionnez l’onglet **Équipes**. Il existe déjà une équipe par défaut dans ce projet, l’équipe **EShopOnWeb**, mais vous allez en créer une nouvelle pour ce labo. Cliquez sur **Nouvelle équipe**.

    ![Dans la fenêtre Paramètres du projet, dans l’onglet « Équipes », cliquez sur « Nouvelle équipe »](images/m1/new_team_v1.png)

4. Dans le volet **Créer une équipe**, dans la zone de texte **Nom de l’équipe**, tapez **EShop-Web**, conservez les valeurs par défaut pour les autres paramètres, puis cliquez sur **Créer**.
...
5. Dans la liste des **Équipes**, sélectionnez l’équipe nouvellement créée pour afficher ses détails.
...
6. Cliquez sur **Itérations et chemins de zone** en haut de la page **EShop-Web** pour commencer à définir la planification et l’étendue de l’équipe.
...
7. En haut du volet **Tableaux**, sélectionnez l’onglet **Itérations**, puis cliquez sur **+ Sélectionner des itérations**.

    ![Dans l’onglet « Itérations », cliquez sur « Sélectionner une itération »](images/m1/EShop-WEB-select_iteration_v1.png)

8. Sélectionnez **EShopOnWeb\Sprint 1**, puis cliquez sur **Enregistrer et fermer**. Notez que ce premier sprint s’affiche dans la liste des itérations, mais que les Dates ne sont pas encore définies.
9. Sélectionnez **Sprint 1**, puis cliquez sur les **points de suspension (...)**. Dans le menu contextuel, sélectionnez **Modifier**.
...
10. Répétez l’étape précédente pour ajouter **Sprint 2** et **Sprint 3**. Nous sommes ainsi actuellement dans la 2e semaine du premier sprint.
...
2. Dans la fenêtre **Éléments de travail**, cliquez sur **+ Nouvel élément de travail > Épopée**.
...
3. Dans la zone de texte **Saisir un titre**, tapez **Formation produit**.
4. Dans le coin supérieur gauche, sélectionnez l’entrée **Non attribué** et, dans la liste déroulante, sélectionnez votre compte d’utilisateur pour affecter le nouvel élément de travail à vous-même.
5. En regard de l’entrée **Zone**, sélectionnez l’entrée **eShopOnWeb** et, dans la liste déroulante, sélectionnez **EShop-WEB**. Cette opération définit la **Zone** sur **eShopOnWeb\EShop-WEB**.
6. En regard de l’entrée **Itération**, sélectionnez l’entrée **eShopOnWeb** et, dans la liste déroulante, sélectionnez **Sprint 2**. Cela définit l’**Itération** sur **eShopOnWeb\Sprint 2**.
7. Cliquez sur **Enregistrer** pour finaliser vos modifications. **Ne fermez pas la fenêtre**.
...
13. Dans le volet **Tableaux**, dans le coin supérieur droit, sélectionnez l’entrée **Éléments de backlog** et, dans la liste déroulante, sélectionnez **Fonctionnalités**.

    > **Remarque** : l’ajout de tâches et d’autres éléments de travail aux fonctionnalités est ainsi facilité.

14. Survolez avec le pointeur de la souris le rectangle représentant la fonctionnalité **Tableau de bord de formation**. Cela révélera les points de suspension (...) dans le coin supérieur droit.
15. Cliquez sur les points de suspension (...) et, dans la liste déroulante, sélectionnez **Ajouter un élément de backlog de produit**.
...
16. Dans la zone de texte du nouvel élément de backlog de produit, tapez **En tant que client, je souhaite afficher de nouveaux tutoriels** et appuyez sur la touche **Entrée** pour enregistrer l’entrée.
...
18. Dans le volet**Tableaux**, dans le coin supérieur droit, sélectionnez l’entrée **Fonctionnalités** et, dans la liste déroulante, sélectionnez **Éléments de backlog**.
...
19. Sous l’onglet **Tableau** du volet **EShop-WEB**, faites glisser le premier élément de travail nommé **En tant que client, je souhaite afficher de nouveaux tutoriels** de l’état **Nouveau** vers l’état **Approuvé**.
...
20. Survolez avec le pointeur de la souris le rectangle représentant l’élément de travail que vous avez déplacé vers l’état **Approuvé**. Un caret orienté vers le bas sera alors visible.
21. Cliquez sur le caret orienté vers le bas pour développer la carte d’élément de travail, sélectionnez l’entrée **Non attribué** et, dans la liste des comptes d’utilisateur, sélectionnez votre compte pour affecter la PBI déplacée à vous-même.
22. Sous l’onglet **Tableau** du volet **EShop-WEB**, faites glisser le deuxième élément de travail nommé **En tant que client, je souhaite voir les tutoriels que j’ai récemment consultés** de l’état **Nouveau** vers l’état **Validé**.
23. Sous l’onglet **Tableau** du volet **EShop-WEB**, faites glisser le troisième élément de travail nommé **En tant que client, je souhaite demander de nouveaux tutoriels** de l’état **Nouveau** à l’état **Terminé**.
...
24. Sous l’onglet **Tableau** du volet **EShop-WEB**, en haut du volet, cliquez sur **Afficher en tant que Backlog** pour afficher le formulaire tabulaire.
...
25. Sous l’onglet **Backlog** du volet **EShop-WEB**, dans le coin supérieur gauche du volet, cliquez sur le deuxième signe plus en partant du haut, situé en regard du premier élément de travail. Le volet **NOUVELLE TÂCHE** s’affiche alors.

    ![Cliquez sur « + » pour créer une Tâche.](images/m1/new_task_v1.png)

26. En haut du volet **NOUVELLE TÂCHE**, dans la zone de texte **Saisir un titre**, tapez **Ajouter une page pour les tutoriels les plus récents**.
27. Dans le volet **NOUVELLE TÂCHE**, dans la zone de texte **Travail restant**, tapez **5**.
28. Dans le volet **NOUVELLE TÂCHE**, dans la liste déroulante **Activité**, sélectionnez **Développement**.
29. Dans le volet **NOUVELLE TÂCHE**, cliquez sur **Enregistrer et fermer**.

    ![Renseignez les champs « Nouvelle tâche », puis cliquez sur « Enregistrer et fermer ».](images/m1/EShop-WEB-save_task_v1.png)

30. Répétez les cinq dernières étapes pour ajouter une autre tâche nommée **Optimiser la requête de données pour les tutoriels les plus récents**. Définissez son **Travail restant** sur **3** et son **Activité** sur **Conception**. Cliquez sur **Enregistrer et fermer** une fois que vous avez terminé.
...
8. Dans l’onglet **Capacité** de la vue **Sprints**, cliquez sur **Enregistrer**.
9. Sélectionnez l’onglet **Tableau des tâches** dans la vue **Sprints**.
...
10. Sous l’onglet **Tableau des tâches** de la vue **Sprints**, dans la zone carrée représentant la page **Ajouter une page pour les tutoriels les plus récents**, définissez le nombre estimé d’heures sur **14** pour qu’il corresponde à votre capacité totale pour ce sprint, que vous avez identifiée à l’étape précédente.
...
12. Cliquez sur l’icône **Configurer les paramètres** d’équipe (directement à droite de l’icône en forme d’entonnoir).
13. Dans le panneau **Paramètres**, sélectionnez l’onglet **Styles**, cliquez sur **+ Règle de style**, sous l’étiquette **Nom de la règle**, dans la zone de texte **Nom**, saisissez **Développement** et, dans la liste déroulante **Couleur de la carte**, sélectionnez le rectangle vert.
...
14. Dans la section **Critères de règle**, dans la liste déroulante **Champ**, sélectionnez **Activité**. Dans la liste déroulante **Opérateur**, sélectionnez **=** puis, dans la liste déroulante **Valeur**, sélectionnez **Développement**.
...
16. Dans le panneau **Paramètres**, sélectionnez l’onglet **Jours de travail**.
...
17. Dans le panneau **Paramètres**, sélectionnez l’onglet **Travailler avec des bogues**.

    > **Remarque** : les entrées de cet onglet vous permettent de spécifier la façon dont les bogues sont présentés sur le tableau.

18. Dans le panneau **Paramètres**, cliquez sur **Enregistrer et fermer** pour enregistrer la règle de style.
...
3. Dans le panneau **Paramètres**, sélectionnez l’onglet **Couleurs de balise**, cliquez sur **+ Couleur de balise**. Dans la zone de texte **Balise**, tapez **données** et conservez la couleur par défaut appliquée.
...
5. Dans le panneau **Paramètres**, sélectionnez l’onglet **Tests**.
...
14. Cliquez sur **+ Colonne**, sous l’étiquette **Nom de colonne**, dans la zone de texte **Nom**, tapez **AQ approuvée** et dans la zone de texte **Limite TEC**, tapez **1**.
...
23. Sous l’onglet **AQ approuvée**, cochez la case **Fractionner la colonne en « En cours » et « Terminé »** pour créer deux colonnes distinctes.
...
24. Sous l’onglet **AQ approuvée**, en bas du panneau, dans la zone de texte **Définition de terminé**, tapez **Réussit \*\*tous les\*\* tests**.
25. Dans le panneau **Paramètres**, cliquez sur **Enregistrer et fermer**.
...
2. Dans l’angle inférieur gauche de la page, cliquez sur le bouton **Paramètres de l’organisation**.
3. Dans le menu vertical **Paramètres de l’organisation**, dans la section **Tableaux**, sélectionnez **Processus**.
4. Dans le volet **Tous les processus**, en regard de l’entrée **Scrum**, sélectionnez le symbole de points de suspension (...) et dans le menu déroulant sélectionnez **Créer un processus hérité**.
...
5. Dans le panneau **Créer un processus hérité à partir de Scrum**, dans la zone de texte **Nom du processus (obligatoire)**, tapez **Scrum personnalisé** et cliquez sur **Créer un processus**.
6. Dans le volet **Tous les processus**, cliquez sur l’entrée **Scrum personnalisé**.

    > **Remarque** : vous devrez peut-être actualiser le navigateur pour afficher le nouveau processus.

7. Dans le volet **Tous les processus > Scrum personnalisé**, sélectionnez **Élément de backlog de produit**.
...
8. Dans le volet **Tous les processus > Scrum personnalisé > Élément de backlog de produit**, cliquez sur **Nouveau champ**.
9. Dans le volet **Ajouter un champ à l’élément de backlog de produit**, sous l’onglet **Définition**, dans la section **Créer un champ**, dans la zone de texte **Nom**, tapez **EShop Ticket ID**.
...
10. Dans le panneau **Ajouter un champ à l’élément de backlog de produit**, cliquez sur **Disposition**.
11. Dans le panneau **Ajouter un champ à l’élément de backlog de produit**, sous l’onglet **Disposition**, dans la zone de texte **Étiquette**, tapez **Ticket ID**, sélectionnez l’option **Créer un groupe**, dans la zone de texte **Groupe**, tapez **EShopOnWeb**, puis cliquez sur **Ajouter un champ**.
...
12. Revenez à la racine **Tous les processus** par le biais de l’exploration à l’aide de la barre de navigation située en haut du volet **Tous les processus > Scrum personnalisé > Élément de backlog de produit**.
13. Dans le volet **Tous les processus**, sélectionnez l’entrée **Scrum**.
...
14. Dans le volet **Tous les processus > Scrum**, sélectionnez l’onglet **Projets**.
15. Dans la liste des projets, dans la ligne contenant l’entrée **eShopOnWeb**, sélectionnez le symbole des points de suspension (...), puis **Modifier le processus**.
16. Dans le volet **Modifier le processus du projet**, dans la liste déroulante **Sélectionner un processus cible**, sélectionnez le processus **Scrum personnalisé**, cliquez sur **Enregistrer**, puis sur **Fermer**.
...
17. Cliquez sur le logo **Azure DevOps** dans le coin supérieur gauche pour revenir à la page racine du compte.
18. Sous l’onglet **Projets**, sélectionnez l’entrée correspondant au projet **eShopOnWeb**.
19. Dans le menu vertical situé à gauche de la page **eShopOnWeb**, sélectionnez **Tableaux** et vérifiez que le volet **Éléments de travail** s’affiche.
20. Dans la liste des éléments de travail, cliquez sur le premier élément de backlog.
21. Vérifiez que vous disposez maintenant du champ **ID de ticket** sous le groupe **eShopOnWeb**, qui a été défini pendant la personnalisation du processus. Vous pouvez le traiter comme n’importe quel autre champ de texte.
...
2. Si nécessaire, dans le volet **Tableaux de bord**, dans le coin supérieur gauche, dans la section **Équipe eShopOnWeb**, sélectionnez **Équipe eShopOnWeb - Vue d’ensemble** et passez en revue le tableau de bord existant.
...
3. Dans le volet **Tableaux de bord**, sélectionnez le menu déroulant en regard du titre **Équipe eShopOnWeb - Vue d’ensemble**, puis sélectionnez **+ Nouveau tableau de bord**.
...
4. Dans le volet **Créer un tableau de bord**, dans la zone de texte **Nom**, tapez **Formation produit**, dans la liste déroulante **Équipe**, sélectionnez l’équipe **EShop-WEB**, puis cliquez sur **Créer**.
...
5. Dans le nouveau volet du tableau de bord, cliquez sur **Ajouter un widget**.
6. Dans le panneau **Ajouter un widget**, dans la zone de texte **Rechercher**, tapez **sprint** pour rechercher les widgets existants qui se concentrent sur les sprints. Dans la liste des résultats, sélectionnez **Vue d’ensemble des sprints**, puis cliquez sur **Ajouter**.
7. Dans le rectangle représentant le widget qui vient d’être ajouté, cliquez sur l’icône de roue dentée **Paramètres** et passez en revue le volet **Configuration**.

    > **Remarque** : le niveau de personnalisation varie selon le widget.

8. Dans le volet **Configuration**, cliquez sur **Fermer** sans apporter de modifications.
9. De retour dans le volet **Ajouter un widget**, dans la zone de texte de **recherche**, tapez à nouveau **sprint** pour rechercher les widgets existants qui se concentrent sur les sprints. Dans la liste des résultats, sélectionnez **Capacité de sprint**, puis cliquez sur **Ajouter**.
10. Dans l’affichage **Tableau de bord**, en haut du volet, cliquez sur **Modification terminée**.
...
11. Dans le volet de navigation vertical du portail Azure DevOps, sélectionnez l’icône **Tableaux** et, dans la liste des éléments **Boards**, sélectionnez **Requêtes**.
12. Dans le volet **Requêtes**, cliquez sur **+ Nouvelle requête**.
13. Dans l’onglet **Éditeur** du volet **Requêtes > Mes requêtes**, dans la liste déroulante **Valeur** de la ligne **Type d’élément de travail**, sélectionnez **Tâche**.
14. Dans l’onglet **Éditeur** du volet **Requêtes > Mes requêtes**, dans la deuxième ligne, colonne **Champ**, sélectionnez **Chemin de la zone**. Dans la liste déroulante **Valeur** correspondante, sélectionnez **eShopOnWeb\\EShop-WEB**.
15. Sélectionnez **Enregistrer la requête.**
